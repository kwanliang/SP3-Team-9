...
public:
    ...
    static Mesh* GenerateLine(const std::string &meshName, Color color, Vector3 p1, Vector3 p2);
    ...
    //static Mesh* GenerateRing(const std::string &meshName, Color color, unsigned numSlice, float outerR = 1.f, float innerR = 0.f, float degree);
